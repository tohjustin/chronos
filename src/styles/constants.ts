// Ensure this file is in sync with "src/styles/_variables.scss"

export const BASE_SIZE = 8;

export const COLOR_WHITE = "#f6f6f6";
export const COLOR_PRIMARY = "#3d9cf4";

export const CHART_COLOR_RANGE: [string, string] = [COLOR_WHITE, COLOR_PRIMARY];
